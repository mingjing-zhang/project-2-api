...
URL_MAP: dict[str, str | None] = {
    ...
    # --- Older posts: explicitly clear (replace bad placeholder with NULL) ---
    ...
    "Building a 4-Leaf Taproot Tree in Python: The First Complete Implementation on Bitcoin Testnet": None,
    "Taproot Control Block Deep Analysis & Stack Execution Visualization | Part 2": None,
    "How Bitcoin P2SH Scripts Work: From 2-of-3 Multisig to Timelocked Inheritance": None,
    "Bitcoin Script Doesn't Execute What's on the Stack: A Developer's Journey From Misconception to Clarity": None,
    "Why Counterparty's Fake-Pubkey Grinding Reveals the Real Boundary Between Bitcoin Consensus and Policy": None,
    "Why V3 Matters: Bitcoin's Relay Layer Was Rewritten, and Most People Didn't Notice": None,
    "Bitcoin Doesn't Use Encryption — What Adam Back's Comment Really Means": None,
}
